...
import { AdminTemplateIdentityModal } from "../modals/admin-template-identity-modal";
...
export function CanvaBuilderCreator({
  ...
  const SendCanvaJSON = async () => {
    ...
    try {
      ...
      setIsLoading(false);
      replace("/home/my-visual-identity");
    }
  };
  ...
  // Função para adicionar linhas de alinhamento
  ...
  return (
    <>
      ...
      {adminModal && (
        <AdminTemplateIdentityModal
          setAdminName={setAdminName}
          setHeigthValue={setHeigthValue}
          setTypeValue={setTypeValue}
          setWidthValue={setWidthValue}
          setAdminModal={setAdminModal}
          setValidit={setValidit}
        />
      )}
    </>
  );
